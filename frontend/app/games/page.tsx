      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {activeTab === 'coinflip' && (
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-center">Pile ou Face</h2>

            <div className="max-w-md mx-auto">
              <div className="mb-6">
                <label className="block text-sm font-medium mb-2">Mise (coins)</label>
                <input
                  type="number"
                  value={coinflipBet}
        ...
        {activeTab === 'cases' && (
          <div className="grid md:grid-cols-3 gap-6">
            {cases.map((caseItem) => (
              <div key={caseItem.id} className="bg-white rounded-2xl p-6 shadow-lg">

...
docker ps | findstr "coinly_backend" >nul
if errorlevel 1 (
...
docker exec -it coinly_backend npm run prisma:generate
if errorlevel 1 (
...
docker exec -it coinly_backend npm run prisma:migrate
if errorlevel 1 (
...
docker exec -it coinly_backend npm run prisma:seed
if errorlevel 1 (
